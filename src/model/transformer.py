# https://github.com/XuMuK1/dla2023/blob/2023/week07/seminar07.ipynb
import numpy as np
import torch
...
class FFTBlock(nn.Module):
    ...
    def __init__(self, d_model, d_inner, n_head, d_k, d_v, fft_conv1d_kernel, fft_conv1d_padding, dropout=0.1):
        ...
        self.pos_ffn = PositionwiseFeedForward(d_model, d_inner, fft_conv1d_kernel, fft_conv1d_padding, dropout)
